;; Vendored from tree-sitter-grammars/tree-sitter-xml at rev
;; 5000ae8f22d11fbe93939b05c1e37cf21117162d (queries/xml/highlights.scm).
;; MIT License, Copyright (c) 2023 ObserverOfTime. Keep this file in sync with
;; the `rev` pinned for [grammars.xml] in extension.toml.
